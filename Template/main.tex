...
%% NOT: inputenc YUKLENMEZ — TeX Live 2025'te UTF-8 girdi varsayilandir ve
%% inputenc'i biblatex/csquotes'tan sonra yuklemek uyari uretir.
\usepackage[T1]{fontenc}      %% Turkce karakterlerin (İ, ş, ğ, ...) dogru render'i
\usepackage{booktabs}         %% sonuc tablolari icin profesyonel cizgiler
\usepackage{tikz}             %% LSTM mimari diyagrami
...
\title{Prediction of Bus Arrival Times in Public Transportation}
\author{Muhammed Bilal Türk, Ömer Faruk Koç}
...
\makejury{14/06/2026}{Prof. Dr. Hasari Çelebi}
...
\input{./Body/Mainmatter/Chapter1}
\input{./Body/Mainmatter/Chapter2}
\input{./Body/Mainmatter/Chapter3}
\input{./Body/Mainmatter/Chapter4}
\input{./Body/Mainmatter/Chapter5}
\input{./Body/Mainmatter/Chapter6}
